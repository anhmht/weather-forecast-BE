...
using GloboWeather.WeatherManagement.Identity.Services;
    ...
    public static class IdentityServiceExtensions
    {
        public static void AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
          services.Configure<JwtSettings>(configuration.GetSection("JwtSettings"));
            ...
            services.AddDbContext<GloboWeatherIdentityDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("GloboWeatherIdentityConnectionString"),
                b => b.MigrationsAssembly(typeof(GloboWeatherIdentityDbContext).Assembly.FullName)));
