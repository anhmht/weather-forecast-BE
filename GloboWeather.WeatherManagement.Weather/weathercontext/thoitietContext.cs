...
namespace GloboWeather.WeatherManagement.Weather.weathercontext
{
    public partial class thoitietContext : DbContext
    {
        ...
        public virtual DbSet<Capgio> Capgio { get; set; }
        public virtual DbSet<Diemdubao> Diemdubao { get; set; }
        public virtual DbSet<Htthoitiet> Htthoitiet { get; set; }
        public virtual DbSet<Icon24> Icon24 { get; set; }
        public virtual DbSet<Icondem> Icondem { get; set; }
        public virtual DbSet<Iconngay> Iconngay { get; set; }
        public virtual DbSet<Iconthoitiet> Iconthoitiet { get; set; }
        public virtual DbSet<May> May { get; set; }
        public virtual DbSet<Mua> Mua { get; set; }
        public virtual DbSet<Nhietdo> Nhietdo { get; set; }
        public virtual DbSet<Thoigian> Thoigian { get; set; }

        // Unable to generate entity type for table 'thoitiet.doamtb'. Please see the warning messages.
        // Unable to generate entity type for table 'thoitiet.giogiat'. Please see the warning messages.
        // Unable to generate entity type for table 'thoitiet.huonggio'. Please see the warning messages.
        // Unable to generate entity type for table 'thoitiet.luongmua'. Please see the warning messages.
        // Unable to generate entity type for table 'thoitiet.thoitiet'. Please see the warning messages.
        // Unable to generate entity type for table 'thoitiet.tocdogio'. Please see the warning messages.
